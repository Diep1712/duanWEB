...
<footer>
      <div
        class="container-fluid text-white p-5"
            ...
            <div class="col-sm-12">
              <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                  ...
                  <p class="mt-4 text-secondary text-decoration-none">
                    Nếu bạn có bất kỳ câu hỏi nào, vui lòng liên hệ với chúng
                    tôi tại hiepnguyenduy2003@gmail.com
                  </p>
                  <p class="mt-4 text-secondary text-decoration-none">
                    <svg
                  ...
                  <p class="text-secondary">
                    ...
                    ><span style="padding-left: 10px">0357854906</span>
                  </p>
                  <p>
                    <svg
                      class="mx-2"
